    ...
    <MainLayout user={user}>
        ...
        {tickets.length === 0 ? (
          <div className="p-8 text-center">
            ...
            <p className="text-gray-500">
              {user ? "Create your first ticket to get started." : "Login to create tickets."}
            </p>
          </div>
        ) : (
      ...
      <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded">
        <p className="text-green-800 text-sm">
          <strong>Render Mode:</strong> Cached — This page is publicly viewable with ISR caching.
          Content revalidates every 60 seconds for optimal CDN performance.
        </p>
      </div>
    </MainLayout>
  );
